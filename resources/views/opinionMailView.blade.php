...
<section id="Home">
    <div class="border-bottom rounded border-info pt-5 pb-4" style="">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                <h4 style="margin-top: -45px;" class="question-label"><b>Opinion Letter (Opinyon)</b></h4>
...
<div class="row" style="margin-top: -60px;">
    <div class="md-12">
        ...
        @endif
                    <form method="post" action="{{ route('opinionMailSend') }}" enctype="multipart/form-data" class="m-5">
                <!-- @csrf -->
            </div> 
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <label>Body (Ang inyong opinyon)</label>
                    <textarea rows="4" class="form-control q-question-body" name="opinion_body" required></textarea>
