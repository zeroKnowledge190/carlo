<main class="hic-documents">
    ...
    <li class="breadcrumb-item active">Hi, {{ Auth::user()->user_firstname }} {{ Auth::user()->user_lastname }} , Manage List of Applications</li>
</ol>
...
<div class="table-responsive">
    <table id="applications-table" class="table-docs table-bordered" width="100%" cellspacing="0">
        <thead>
            <tr>
