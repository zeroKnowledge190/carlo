...
<section id="Home">
    <div class="border-bottom rounded border-info pt-5 pb-4" style="">
        ...
        <div class="row">
            <div class="col-md-3">
                From: <p><b>{{ $viewA->created_by }}</b></p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <label>Date Created (Petsa)</label><br>
                {{ $viewA->date_created }}
                <input type="hidden" class="form-control a-date-created" />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                {{ $viewA->entity_name }}
                <input type="hidden" class="form-control a-entity" />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                {{ $viewA->subject }}
                <input type="hidden" class="form-control a-subject" />
                <span id="a-subject-text"></span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <label><b>Dear Sir / Madaam</b></label><br>
                {{ $viewA->dear }}
