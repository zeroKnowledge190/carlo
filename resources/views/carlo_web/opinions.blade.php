...
<div class="row">
    <div class="col-md-3">
        <label>Date Created (Petsa)</label>
            <input type="date" class="form-control o-date-created" />
...
<div class="row">
    <div class="col-md-6">
        <label>Entity which letter is directed to (Para sa anong ahensya)</label>
            <input type="text" class="form-control o-entity" />
        <span id="o-entity-text"></span>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <label>Body (Ang inyong opinyon)</label>
            <textarea rows="4" class="form-control o-opinion-body"></textarea>
...
<form enctype="multipart/form-data" action="/save_upload_opinion_files" method="post">
<div class="row">
    <div class="col-md-6">
        <label>Upload Image</label><br>
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input style="height: 2.7em;" type="file" class='form-control' name="hic_documents" required>
    <input type="hidden" value="Opinion" class='form-control' name="file_name">
</div>
<div class="col-md-3">
...
<div class="row">
    <div class="col-md-3">
        <button id="submit-o-btn" type="button" class="btn btn-success btn-sm submitOpinion">Submit</button>
            </div>
        </div>
    </div>
</div>
