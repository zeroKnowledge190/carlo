            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="form-group"><label>Email address<br></label><input type="text" class="form-control c-email" placeholder="Enter email" style=""><span id="c-email-text"><span></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-12" style="">
                        <div class="form-group"><label>Kasarian <i>(Gender)</i></label><select class="form-control c-gender" name="gender"><option></option><option value="Male">Male</option><option>Female</option></select><span id="c-gender-text"><span></div>
                        <div class="form-group"><label>Mobile number<br></label><input type="text" class="form-control c-mobile-number" placeholder="" style=""><span id="c-mobile-number-text"><span></div>
                   </div>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group"><label>Password <i></i><br></label><input id="hic-password" type="text" class="form-control c-password" style="" placeholder=""><span id="c-password-text"><span></div>
                                            </div>
                                                <div class="col-md-6">
                                            <div class="form-group"><label>Re-Type Password<i></i></label><input id="hic-password-con" type="text" class="form-control c-password-confirm" placeholder="" style=""><span id="c-password-confirm-text"><span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="row" style="justify-content: center;">
                      	<div class="col-md-4">
                		    ...
                		    <p class="link" style="justify-content:center;"><a href="{{ url('/questions-form') }}" target="_blank">QUESTION</a></p></div>
                	    </div>
                	    <div class="col-md-4">
                		    <img src="/carlo/assets/Survey form.png" >
                		    <div class="row" style="justify-content:center; font-weight: bold;">
                		    <p class="link" style="justify-content:center;"><a href="{{ url('/opinions-form') }}" target="_blank">OPINION</a></p></div>
                	    </div>
          				<div class="col-md-4">
          				    <img src="/carlo/assets/Petition letter.png">
          				        <div class="row" style="justify-content:center;font-weight: bold;">
                            <p class="link" style="justify-content:center;"><a href="{{ url('/requisitions-form') }}" target="_blank">REQUISITION</a></p></div>
                        </div>
          		  	</div>
          		</div>
          	</div>
                ...
                <div class="col-md-12">
                    <div class="row" style="justify-content: center;">
                      	<div class="col-md-4">
                		    <img src="/carlo/assets/Survey form.png" >
                		        <div class="row" style="justify-content:center; font-weight: bold;">
                		    <p class="link" style="justify-content:center;"><a href="{{ url('/petitions-form') }}" target="_blank">PETITION</a></p></div>
                	    </div>
                	    <div class="col-md-4">
                		    <img src="carlo/assets/Petition letter.png" >
                		        <div class="row" style="justify-content:center; font-weight: bold;" >
                            <p class="Link" style="justify-content:center;"><a href="{{ url('/applications-form') }}" target="_blank">APPLICATION</a></p></div>
                	    </div>
          				<div class="col-md-4">
          				    <img src="/carlo/assets/Survey form.png">
          				        <div class="row" style="justify-content:center; font-weight: bold;">
          				  	<p class="link" style="justify-content:center;"><a href="{{ url('/survey-form') }}" target="_blank">SURVEY</a></p></div>
          				</div>
          		  	</div>
          		</div>
          	</div>
...
<div class="col-md-3"><img class="d-block img-fluid mx-auto pt-3" src="/carlo/assets/DA LOGO.png">
    <div class="row">
        <div class="col-md-12">
