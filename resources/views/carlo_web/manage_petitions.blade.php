<main class="hic-documents">
    ...
    <li class="breadcrumb-item active">Hi, {{ Auth::user()->user_firstname }} {{ Auth::user()->user_lastname }} , Manage List of Petitions</li>
</ol>
...
<div class="table-responsive">
    <table id="petitions-table" class="table-docs table-bordered" width="100%" cellspacing="0">
        <thead>
            <tr>
