...
<div class="row">
    <div class="col-md-3">
        <label>Date Created (Petsa)</label>
            <input type="date" class="form-control q-date-created" />
...
<div class="row">
    <div class="col-md-6">
        <label>Entity which letter is directed to (Para sa anong ahensya)</label>
            <input type="text" class="form-control q-entity" />
        <span id="q-entity-text"></span>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <label>Body (Ang inyong tanong)</label>
...
<form enctype="multipart/form-data" action="/save_upload_question_files" method="post">
<div class="row">
    <div class="col-md-6">
        <label>Upload Image</label><br>
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input style="height: 2.7em;" type="file" class='form-control' name="hic_documents" required>
    <input type="hidden" value="Question" class='form-control' name="file_name">
</div>
<div class="col-md-3">
...
<div class="row">
    <div class="col-md-3">
        <button id="submit-q-btn" type="button" class="btn btn-success btn-sm submitQuestion">Submit</button>
            </div>
            </div>
        </div>
    </div>
