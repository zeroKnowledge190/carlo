...
<div class="col-md-2">
    <label for="bookings-client-no">{{ $booking->drivers_name }}</label>                          
</div>
<div class="col-md-2">
    <label for="vehicle-label">{{ $booking->vehicle_label }}</label>                          
</div>
<div class="col-md-3">
    <label for="travel-date-time">{{ $booking->book_month }} {{ $booking->book_day }} {{ $booking->book_year }} - {{ $booking->book_hour }} {{ $booking->day_format }}</label>                          
    </div>
</div>
...
<div class="modal-body bt-industry">
    <div class="row skills-form-modal">
        ...
        <div class="row booking-status-row">
        <div class="col-md-3">
