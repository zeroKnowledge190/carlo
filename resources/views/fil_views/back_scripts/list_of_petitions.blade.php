...
function viewListOfPetitions(event){
    event.preventDefault();
        ...
        success: function(html){
            ...
            setTimeout(loadPetitionsDataTable, 1000);
        }
    });
}

function loadPetitionsDataTable(){
    $('.spinner-red-docs').hide();
    $('.docs-body').show();
    $('#petitions-table').DataTable().destroy();
