...
<div class="row" style="margin-top: -60px;">
    <div class="md-12">
        ...
        @endif
                    <form method="post" action="{{ route('questionMailSend') }}" enctype="multipart/form-data" class="m-5">
                <!-- @csrf -->
            </div> 
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <label>Body (Ang inyong tanong)</label>
                    <textarea rows="4" class="form-control q-question-body" name="question_body"></textarea>
