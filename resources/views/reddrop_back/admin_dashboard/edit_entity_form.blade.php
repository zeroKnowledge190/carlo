<main class="hic-documents">
    ...
    @endif
<form enctype="multipart/form-data" action="/save_edit_entity/{{ $editEntity->ent_id_no }}" method="post">
<div class="row">
    <div class="col-md-3">
        <label>Entity Name</label><br>
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="text" class='form-control' value="{{ $editEntity->entity_name }}" name="entity_name">
    </div>
    <div class="col-md-3">
        <label>Email</label><br>
        <input type="email" class='form-control' value="{{ $editEntity->entity_email }}" name="entity_email">
    </div>
</div>
<div class="row">
    <div class="col-md-3">
