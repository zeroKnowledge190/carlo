<main class="hic-documents">
    ...
    <li class="breadcrumb-item active">Hi, {{ Auth::user()->user_firstname }} {{ Auth::user()->user_lastname }} ,Add Entity</li>
</ol>
...
<form enctype="multipart/form-data" action="/save_add_entity" method="post">
<div class="row">
    <div class="col-md-3">
