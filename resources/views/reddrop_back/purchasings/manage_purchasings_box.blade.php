...
<div class="card-header docs-h">
    <i class="fa fa-table mr-1"></i>
        List of Items you're about to purchase
        </div>
    <div class="row box-spinner">
</div> 
<div class="card-body docs-body">
    <form id="search-items-form">
        <div class="row">
            ...
            <div class="col-md-3">
        <button id="user-search-btn" type="button" class="btn btn-success btn-sm" onclick="searchPurchasedItems(event)"><i class="fa fa-search"></i> Search</button>
    </div>
</div>
</form>

<div class="table-responsive">
    <table id="hic-orders-datatable" class="table-docs table-bordered" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th>Company</th>
                <th>Item Name</th>
...
@include('reddrop_back.modals.purchasings.edit_purchasings')
